...
@Mod("posapc")
public class PosapcMod {
	public static final Logger LOGGER = LogManager.getLogger(PosapcMod.class);
	public static final String MODID = "posapc";
