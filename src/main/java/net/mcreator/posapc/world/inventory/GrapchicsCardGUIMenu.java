...
package net.mcreator.posapc.world.inventory;
...
public class GrapchicsCardGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GrapchicsCardGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
